...
//  --------------------
//  Evaluates a directional light and returns ESTKZ SH data.  The output 
//  vector is computed so that if the intensity of R/G/B is unit the resulting
//  exit radiance of a point directly under the light on a diffuse object with
//  an albedo of 1 would be 1.0.  This will compute 3 ESTKZ samples, pROut
...
//  --------------------
//  Evaluates a spherical light and returns ESTKZ SH data.  There is no 
//  normalization of the intensity of the light like there is for directional
//  lights, care has to be taken when specifiying the intensities.  This will 
//  compute 3 ESTKZ samples, pROut has to be specified, while pGout and 
//  pBout are optional.
//
//  Parameters:
//   Order
...
//  D3DXSHEvalConeLight:
//  --------------------
//  Evaluates a light that is a cone of constant intensity and returns ESTKZ
...
//  This will compute 3 ESTKZ samples, pROut has to be specified, while pGout
