...
namespace ImGui
{
    ...
    IMGUI_API void          ShadowText(const char* label, ImU32 text_col, ImU32 shadow_col, float shadow_thickness, const ImVec2& pos_text);
    ...
    IMGUI_API bool          ElwaTab(const char* icon, int* tab, int number);
